          ...
          <div className="md:col-span-3 space-y-8 animate-slide-up">
            {activeTab === 'profile' && (
              <Card className="p-8 border-none shadow-xl rounded-3xl bg-white">
                <h2 className="text-xl font-bold text-primary mb-8 border-b pb-4 flex items-center gap-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 mb-8">
                  <div className="space-y-2">
                    ...
                    <input type="text" defaultValue="محمد علي" className="w-full h-12 px-4 rounded-xl bg-muted/30 border-2 border-transparent focus:border-primary focus:bg-white outline-none font-bold transition-all" />
                  </div>
                  <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <input type="text" defaultValue="موظف أرشفة" className="w-full h-12 px-4 rounded-xl bg-muted/30 border-2 border-transparent focus:border-primary focus:bg-white outline-none font-bold transition-all" />
                  </div>
                </div>
              ...
              <Card className="p-8 border-none shadow-xl rounded-3xl bg-white">
                ...
                <div className="space-y-6 max-w-md">
                  <div className="space-y-2">
                    ...
                    <input type="password" placeholder="••••••••" className="w-full h-12 px-4 rounded-xl bg-muted/30 border-2 border-transparent focus:border-primary focus:bg-white outline-none font-bold transition-all" />
                  </div>
                  <div className="space-y-2">
            ...
            {(activeTab === 'profile' || activeTab === 'language') && (
              <Card className="p-8 border-none shadow-xl rounded-3xl bg-white">
                <h2 className="text-xl font-bold text-primary mb-8 border-b pb-4 flex items-center gap-2">
                ...
                <div className="space-y-6">
                  <div className="flex items-center justify-between p-4 rounded-2xl bg-muted/20 hover:bg-muted/30 transition-colors group">
                    <div className="flex items-center gap-4">
                      <div className="p-3 bg-secondary/10 rounded-xl text-secondary group-hover:bg-secondary group-hover:text-white transition-all"><ShieldCheck className="w-6 h-6" /></div>
                      <div>
                  ...
                  <div className="flex items-center justify-between p-4 rounded-2xl bg-muted/20 hover:bg-muted/30 transition-colors group">
                    <div className="flex items-center gap-4">
                      <div className="p-3 bg-orange-500/10 rounded-xl text-orange-600 group-hover:bg-orange-600 group-hover:text-white transition-all"><Database className="w-6 h-6" /></div>
                      <div>
